...
$sql = "SELECT * ";
$sql.=" FROM users u, clients c,reservation s, cars r where u.UserID=c.UserID and c.ClientID=s.ClientID and c.cStatus='Active' and s.CarNumber=r.CarNumber";
...
$sql = "SELECT * ";
$sql.=" FROM users u,clients c,reservation s, cars r where u.UserID=c.UserID and c.ClientID=s.ClientID and c.cStatus='Active' and s.CarNumber=r.CarNumber and 1=1";
...
//$duration = round($row["Duration"]/60);
	...
	$nestedData[] = $row["Duration"]." Hr(s)";
	$nestedData[] = $row["TotalCharge"];
	$nestedData[] = $row["ReservDate"];
